...
Public MustInherit Class WebFormBase(Of V As IWebUI, T As ControllerBase(Of V))
...
#Region " Web Form Designer Generated Code "
  ...
  Private Sub Base_Init(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Init
...
#End Region
  ...
  Public Shadows Event PreLoad(ByVal sender As Object, ByVal e As EventArgs) Implements IWebUI.PreLoad

  Public Shadows Event LoadComplete(ByVal sender As Object, ByVal e As EventArgs) Implements IWebUI.LoadComplete
  ...
  Private Sub Base_PreLoad(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.PreLoad
    RaiseEvent PreLoad(Me, e)
  End Sub
  Private Sub Base_LoadComplete(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.LoadComplete
