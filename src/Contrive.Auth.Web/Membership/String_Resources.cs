...
{
  internal static class String_Resources
  {
    internal const string Auth_rule_names_cant_contain_char =
    ...
    internal const string Connection_string_not_found =
    ...
    internal const string Membership_more_than_one_user_with_email =
      "More than one user has the specified e-mail address.";

    internal const string Membership_password_too_long =
      "The password is too long: it must not exceed 128 chars after encrypting.";

    internal const string Membership_PasswordRetrieval_not_supported =
    ...
    internal const string PageIndex_PageSize_bad =
    ...
    internal const string Parameter_too_long =
      "The parameter '{0}' is too long: it must not exceed {1} chars in length.";

    internal const string Password_does_not_match_regular_expression =
      "The parameter '{0}' does not match the regular expression specified in config file.";

    internal const string Password_need_more_non_alpha_numeric_chars =
    ...
    internal const string PersonalizationProvider_ApplicationNameExceedMaxLength =
      "The ApplicationName cannot exceed character length {0}.";

    internal const string PersonalizationProvider_BadConnection =
      "The specified connectionStringName, '{0}', was not registered.";

    internal const string PersonalizationProvider_CantAccess =
      "A connection could not be made by the {0} personalization provider using the specified registration.";

    internal const string PersonalizationProvider_NoConnection =
      "The connectionStringName attribute must be specified when registering a personalization provider.";

    internal const string PersonalizationProvider_UnknownProp =
    ...
    internal const string Provider_can_not_retrieve_hashed_password =
    ...
    internal const string Provider_Schema_Version_Not_Match =
    ...
    internal const string SiteMapProvider_cannot_remove_root_node =
      "Root node cannot be removed from the providers, use RemoveProvider(string providerName) instead.";

    internal const string SqlError_Connection_String =
    ...
    internal const string SqlExpress_file_not_found_in_connection_string =
      "SQL Express filename was not found in the connection string.";

    internal const string SqlPersonalizationProvider_Description =
    ...
    internal const string Value_must_be_non_negative_integer =
      "The value must be a non-negative 32-bit integer for property '{0}'.";

    internal const string Value_must_be_positive_integer =
    ...
    internal const string XmlSiteMapProvider_cannot_add_node =
    ...
    internal const string XmlSiteMapProvider_cannot_find_provider =
      "Provider {0} cannot be found inside XmlSiteMapProvider {1}.";

    internal const string XmlSiteMapProvider_cannot_remove_node =
    ...
    internal const string XmlSiteMapProvider_Not_Initialized =
      "XmlSiteMapProvider is not initialized. Call Initialize() method first.";

    internal const string XmlSiteMapProvider_Only_One_SiteMapNode_Required_At_Top =
      "Exactly one <siteMapNode> element is required directly inside the <siteMap> element.";

    internal const string XmlSiteMapProvider_Only_SiteMapNode_Allowed =
    ...
    internal const string PersonalizationProviderHelper_TrimmedEmptyString =
      "Input parameter '{0}' cannot be an empty string.";

    internal const string StringUtil_Trimmed_String_Exceed_Maximum_Length =
    ...
    internal const string MinRequiredNonalphanumericCharacters_can_not_be_more_than_MinRequiredPasswordLength =
      "The minRequiredNonalphanumericCharacters can not be greater than minRequiredPasswordLength.";

    internal const string PersonalizationProviderHelper_Empty_Collection =
      "Input parameter '{0}' cannot be an empty collection.";

    internal const string PersonalizationProviderHelper_Null_Or_Empty_String_Entries =
      "Input parameter '{0}' cannot contain null or empty string entries.";

    internal const string PersonalizationProviderHelper_CannotHaveCommaInString =
      "Input parameter '{0}' cannot have comma in string value '{1}'.";

    internal const string PersonalizationProviderHelper_Trimmed_Entry_Value_Exceed_Maximum_Length =
      "Trimmed entry value '{0}' of input parameter '{1}' cannot exceed character length {2}.";

    internal const string PersonalizationProviderHelper_More_Than_One_Path =
    ...
    internal const string PersonalizationAdmin_UnexpectedPersonalizationProviderReturnValue =
      "The negative value '{0}' is returned when calling provider's '{1}' method.  The method should return non-negative integer.";

    internal const string PersonalizationProviderHelper_Null_Entries =
      "Input parameter '{0}' cannot contain null entries.";

    internal const string PersonalizationProviderHelper_Invalid_Less_Than_Parameter =
      "Input parameter '{0}' must be greater than or equal to {1}.";

    internal const string PersonalizationProviderHelper_No_Usernames_Set_In_Shared_Scope =
    ...
    internal const string Not_configured_to_support_password_resets =
    ...
    internal const string DbFileName_can_not_contain_invalid_chars =
      "The database filename can not contain the following 3 characters: [ (open square brace), ] (close square brace) and ' (single quote)";

    internal const string SQL_Services_Error_Deleting_Session_Job =
    ...
    internal const string SQL_Services_Error_Executing_Command =
    ...
    internal const string SQL_Services_Database_Empty_Or_Space_Only_Arg =
      "The database name cannot be empty or contain only white space characters.";

    internal const string SQL_Services_Database_contains_invalid_chars =
    ...
    internal const string SQL_Services_Error_Cant_Uninstall_Nonexisting_Database =
      "Cannot uninstall the specified feature(s) because the SQL database '{0}' does not exist.";

    internal const string SQL_Services_Error_Cant_Uninstall_Nonempty_Table =
    ...
    internal const string SQL_Services_Error_missing_custom_database =
      "The database name cannot be null or empty if the session state type is SessionStateType.Custom.";

    internal const string SQL_Services_Error_Cant_use_custom_database =
    ...
    internal const string Error_parsing_sql_partition_resolver_string =
      "Error parsing the SQL connection string returned by an instance of the IPartitionResolver type '{0}': {1}";

    internal const string Error_parsing_session_sqlConnectionString =
      "Error parsing <sessionState> sqlConnectionString attribute: {0}";

    internal const string No_database_allowed_in_sqlConnectionString =
    ...
    internal const string No_database_allowed_in_sql_partition_resolver_string =
    ...
    internal const string Cant_connect_sql_session_database_partition_resolver =
    ...
    internal const string Login_failed_sql_session_database =
      "Failed to login to session state SQL server for user '{0}'.";

    internal const string Need_v2_SQL_Server =
      "Unable to use SQL Server because ASP.NET version 2.0 Session State is not installed on the SQL server. Please install ASP.NET Session State SQL Server version 2.0 or above.";

    internal const string Need_v2_SQL_Server_partition_resolver =
    ...
    internal const string Config_base_unrecognized_attribute =
    ...
    internal const string Unexpected_provider_attribute =
      "The attribute '{0}' is unexpected in the configuration of the '{1}' provider.";

    internal const string Only_one_connection_string_allowed =
      "SqlWebEventProvider: Specify either a connectionString or connectionStringName, not both.";

    internal const string Cannot_use_integrated_security =
    ...
    internal const string Must_specify_connection_string_or_name =
      "SqlWebEventProvider: Either a connectionString or connectionStringName must be specified.";

    internal const string Invalid_max_event_details_length =
    ...
    internal const string Sql_webevent_provider_events_dropped =
      "{0} events were discarded since last notification was made at {1} because the event buffer capacity was exceeded.";

    internal const string Invalid_provider_positive_attributes =
